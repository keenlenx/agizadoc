 ...
 */
class Fin_Checklist extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return Fin_ChecklistQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new Fin_ChecklistQuery(get_called_class());
    }
}
